...
import { BookOpen, Flame, HelpCircle, MessageSquare, FolderOpen, Lightbulb, Menu, X } from 'lucide-react'
        ...
        <>
          ...
          <div className="fixed inset-y-0 left-0 z-50 w-64 bg-background border-r border-border p-4 overflow-y-auto lg:hidden">
            <div className="flex items-center justify-between mb-4">
              <span className="font-semibold text-text-primary text-sm">과목 선택</span>
              <button onClick={() => setOpen(false)}><X size={16} className="text-muted" /></button>
            </div>
